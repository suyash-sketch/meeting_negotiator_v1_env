...
class MeetingNegotiatorV1Environment(Environment):
    ...
    def _get_policy_text(self) -> str:
        return (
            "SCORING POLICY:\n"
            "Final score = weighted components with stability penalties and recovery credit.\n"
            "Working hours and overlaps are enforced by actions; not rescored at submit.\n"
            "  1. Completion (0.40): fraction of requests scheduled\n"
            "  2. Deadline Compliance (0.25): meetings finish before deadline\n"
            "  3. Preference Quality (0.15): preferred hours (soft)\n"
            "  4. Efficiency (0.10): spare turns vs max_turns when submitting\n"
            "  5. Investigation Discipline (0.10): inspect relevant attendees (HARD*); else full credit\n"
            "  6. Stability Penalty: harmful transitions reduce final score\n"
            "  7. Recovery Credit: fixing recovery work restores some score\n\n"
            "PER-STEP PENALTIES:\n"
