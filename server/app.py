...
"""
FastAPI application for the Meeting Negotiator V1 Environment.

This module creates an HTTP server that exposes the MeetingNegotiatorV1Environment
...
app = create_app(
    ...
    env_name="meeting_negotiator_v1",
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    This function enables running the server without Docker:
        ...
        python -m meeting_negotiator_v1.server.app
    ...
    multiple workers:
        uvicorn meeting_negotiator_v1.server.app:app --workers 4
    """
    import uvicorn
